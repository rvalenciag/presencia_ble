...
- `NSesion`, `NAsistencia` — nacen en sus fases (CU09; NAsistencia = consola CU12–CU14: `useAsistenciaManual`, `useHistorial`, `useReporte`). `NTransmitirPresencia` (CU10) y `NEscanearAsistencia` (CU11) — radio por rol (ADR-019).
- `Servicio/ExcelCsvServicio` — intercambio de archivos (leer nómina CU03, escribir/compartir reporte CU14; ADR-020).
